...
const leetcodeProgress_router_1 = __importDefault(require("./routes/leetcodeProgress.router"));
...
const corsOptions = (req, callback) => {
    ...
    const origin = (req.headers.origin ||
        ((_a = req.headers["x-forwarded-host"]) === null || _a === void 0 ? void 0 : _a.toString()) ||
        "")
...
app.use("/api/private/progress", (0, cors_1.default)(corsOptions), leetcodeProgress_router_1.default);
app.get("/", (req, res) => {
